...
const ESFCU_DISCLOSURES = [
  ...
  'Brand assets are ESFCU\'s own, used to make the demo recognisable: the mortarboard mark is cropped from the lockup at esfcu.org, the navy (#003768) is sampled from it, and every photograph in both briefings is published on esfcu.org — the President/CEO portrait and the member image in the board briefing, and the member-security photograph on the risk briefing\'s cover. They are reproduced here for an ESFCU-facing demonstration only. Exact hex values, typography and the approved lockup still need confirming against the ESFCU brand kit.',
];
