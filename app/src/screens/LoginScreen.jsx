    ...
    <div className="min-h-screen bg-gradient-to-br from-[#001a4d] to-brand flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <div className="w-14 h-14 rounded-2xl bg-white flex items-center justify-center mx-auto mb-5 shadow-lg">
            <img src="/logos/newfold-icon.svg" alt="Newfold Digital" className="w-9 h-9 object-contain" />
          </div>
