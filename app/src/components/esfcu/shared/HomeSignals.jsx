...
// ESFCU home priority signals — the hero briefing card, shared by both personas.
// The primary signal is promoted to a navy hero tile carrying the "View Full
// Briefing" affordance; the two next-most-important signals render as standard
// mini-cards. Clicking the hero body routes into its chat drill; the button
// launches Presentation Mode.
//
// `eyebrow` and `eyebrowIcon` are the only things that differ between the
// personas: the CEO's hero is a funding watch, the CRO's is a scam surge, and
// each has to say which beat it belongs to before the headline lands.
export default function HomeSignals({
  ...
  signalToChip,
  onViewFullBriefing,
  eyebrow = 'Watch · Funding & liquidity',
  eyebrowIcon: EyebrowIcon = TrendingDown,
  briefingLabel = 'View Full Briefing',
}) {
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-2 mb-1.5">
              ...
              <span className="inline-flex items-center gap-1.5 text-[10px] font-semibold uppercase tracking-wide" style={{ color: ACCENT_SOFT }}>
                <EyebrowIcon className="h-3 w-3" /> {eyebrow}
              </span>
              {conf != null ? (
            ...
            <div className="mt-3 flex flex-wrap items-center gap-x-3 gap-y-2">
              ...
              >
                <Presentation className="h-3.5 w-3.5" /> {briefingLabel}
              </button>
              {primary.metric_text ? (
