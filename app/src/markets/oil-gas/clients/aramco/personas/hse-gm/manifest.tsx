/**
 * Persona: General Manager, Health, Safety and Environment — Aramco (illustrative).
 *
...
const manifest: PersonaManifest = {
  ...
  inlineComponents: (msg) => {
    ...
    // Step 1 — situational briefing. Signals and KPI tiles come from the
    // workspace; the site map is what makes the briefing a picture.
    if (k === 'aramco_hse_greeting' || k === 'aramco_hse_site_map' || k === 'aramco_hse_surge_exposure') {
      out.push(<SiteMap key="site-map" />);
    }

    // Step 2 — permit violations, with the evidence behind each flag.
