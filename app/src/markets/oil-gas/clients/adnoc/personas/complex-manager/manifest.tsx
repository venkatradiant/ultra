/**
 * Persona: Complex Manager (site VP) — ADNOC (illustrative).
 *
...
import signals from '@/data/adnoc/complex-manager/signals.json';
import dataSources from '@/data/adnoc/_shared/dataSources.json';
import capabilityCallouts from '@/data/adnoc/complex-manager/capabilityCallouts.json';
import kpis from '@/data/adnoc/complex-manager/kpis.json';
...
const manifest: PersonaManifest = {
  ...
  ui: {
    greetingFlowKey: 'adnoc_cm_greeting',
    ...
    goldenPathChip: {
      adnoc_cm_greeting: 'Show me safety exposure by unit',
      adnoc_cm_unit_rollup: 'What is the schedule versus safety trade-off?',
      adnoc_cm_schedule_safety: 'What happens at the next surge?',
      adnoc_cm_surge: "What would I tell the board's safety committee today?",
      adnoc_cm_headcount: "What would I tell the board's safety committee today?",
      adnoc_cm_board: 'Assemble the committee pack',
      adnoc_cm_committee_pack: 'Show me safety exposure by unit',
    },
    flowKeyToCapabilityTrigger: {
      adnoc_cm_greeting: 'home_load',
      adnoc_cm_unit_rollup: 'ask_turn_1',
      adnoc_cm_schedule_safety: 'ask_turn_2',
      adnoc_cm_surge: 'ask_turn_2',
      adnoc_cm_headcount: 'ask_turn_3',
      adnoc_cm_board: 'ask_turn_4',
      adnoc_cm_committee_pack: 'ask_turn_4',
    },
    stats,
    signalToChip: {
