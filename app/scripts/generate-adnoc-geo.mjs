/**
 * Generates the TrackLynk.AI site geometry fixtures for the ADNOC tenant.
 *
 * Run: node scripts/generate-adnoc-geo.mjs
 *
 ...
 *   The facility is INVENTED. It is not a real ADNOC site, and the geographic
...
const OUT = join(dirname(fileURLToPath(import.meta.url)), '..', 'src', 'data', 'adnoc', 'hse-gm');
...
// 1.67 m per unit — a 2.0 x 1.17 km site. That is small for a 817,000 bpd
// complex, so the site is scaled to 3.8 x 2.22 km, which is in the right range
// for the capacity the narrative claims.
const ANCHOR = { lon: 52.7, lat: 24.1 }; // deliberately round; see posture note
const VIEW = { w: 1200, h: 700 };
const SITE_M = { w: 3800, h: 2217 };
...
const ZONES = [
  { id: 'Z1', name: 'CDU-4 — Crude Distillation', short: 'CDU-4', hazard: 'high', zoneType: 'Work Place', icon: 'hazard', occupancy: 520, x: 70, y: 96, w: 250, h: 170, people: 405, permits: 78, highRiskPermits: 12 },
  { id: 'Z2', name: 'RFCC-2 — Residue Cracker', short: 'RFCC-2', hazard: 'high', zoneType: 'Work Place', icon: 'hazard', occupancy: 650, x: 340, y: 96, w: 250, h: 170, people: 540, permits: 112, highRiskPermits: 21 },
  { id: 'Z3', name: 'DCU-3 — Delayed Coker', short: 'DCU-3', hazard: 'high', zoneType: 'Work Place', icon: 'hazard', occupancy: 600, x: 610, y: 96, w: 250, h: 170, people: 495, permits: 96, highRiskPermits: 18 },
  { id: 'Z4', name: 'SRU-5 — Sulphur Recovery', short: 'SRU-5', hazard: 'high', zoneType: 'Work Place', icon: 'hazard', occupancy: 420, x: 880, y: 96, w: 250, h: 170, people: 320, permits: 68, highRiskPermits: 10 },
  { id: 'Z5', name: 'Tank Farm West', short: 'Tank W', hazard: 'medium', zoneType: 'Work Place', icon: 'building', occupancy: 320, x: 70, y: 296, w: 340, h: 150, people: 240, permits: 52, highRiskPermits: 6 },
  { id: 'Z7', name: 'Utilities and Flare', short: 'Utilities', hazard: 'high', zoneType: 'Work Place', icon: 'hazard', occupancy: 430, x: 430, y: 296, w: 290, h: 150, people: 345, permits: 60, highRiskPermits: 7 },
  { id: 'Z8', name: 'Ruwais Marine Terminal', short: 'Marine', hazard: 'medium', zoneType: 'Work Place', icon: 'building', occupancy: 240, x: 740, y: 296, w: 390, h: 150, people: 160, permits: 33, highRiskPermits: 0 },
  { id: 'Z6', name: 'Tank Farm East', short: 'Tank E', hazard: 'medium', zoneType: 'Work Place', icon: 'building', occupancy: 260, x: 70, y: 476, w: 340, h: 150, people: 185, permits: 42, highRiskPermits: 4 },
  { id: 'Z9', name: 'Central Admin and Control', short: 'Admin', hazard: 'low', zoneType: 'Work Place', icon: 'building', occupancy: 360, x: 430, y: 476, w: 290, h: 150, people: 275, permits: 15, highRiskPermits: 0 },
  { id: 'Z10', name: 'West Gate', short: 'West Gate', hazard: 'low', zoneType: 'Access Control', icon: 'access', occupancy: 200, x: 740, y: 476, w: 180, h: 150, people: 125, permits: 7, highRiskPermits: 0 },
  { id: 'Z11', name: 'Parking Muster Point', short: 'Muster', hazard: 'low', zoneType: 'Muster Zone', icon: 'muster', occupancy: 2600, x: 940, y: 476, w: 190, h: 150, people: 90, permits: 4, highRiskPermits: 0 },
];
...
const MUSTER_POINTS = [
  ...
  { id: 'M1', name: 'Assembly Point A — West', x: 200, y: 690, covers: ['Z1', 'Z5'], capacity: 800, radiusM: 160 },
  { id: 'M2', name: 'Assembly Point B — South', x: 200, y: 640, covers: ['Z6', 'Z10'], capacity: 800, radiusM: 160 },
  { id: 'M3', name: 'Assembly Point C — East', x: 1035, y: 660, covers: ['Z3', 'Z4'], capacity: 800, radiusM: 160 },
  { id: 'M4', name: 'Assembly Point D — Terminal', x: 935, y: 380, covers: ['Z8'], capacity: 400, radiusM: 130 },
  { id: 'M5', name: 'Assembly Point E — Central', x: 575, y: 660, covers: ['Z2', 'Z7', 'Z9'], capacity: 400, radiusM: 130 },
];
...
function buildSite() {
  ...
  features.push(line([[430, 271], [430, 96]], { kind: 'piperack', name: 'RFCC-2 rack tie-in', heightM: rack }));
  features.push(line([[700, 271], [700, 96]], { kind: 'piperack', name: 'DCU-3 rack tie-in', heightM: rack }));
...
console.log('workers.geojson ', workers.features.length, 'workers (expected 3180)');
